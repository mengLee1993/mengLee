...
var $dp, WdatePicker; (function() {
    ...
    A = $.$dpPath || J();
    if ($.$wdate) K(A + "skin/messageWdatePicker.css");
    V = Y;
    if ($.$crossFrame) {
        try {
        ...
        if (C) {
            ...
            if (!L.el || L.el["My97Mark"] === true || L.el.disabled || ($dp.dd && P($dp.dd) != "none" && $dp.dd.style.left != "-970px")) {
                try {
					...
					if(L.el.validateCtrl != null)
						L.el.validateCtrl.validate();
                } catch(A) {}
                return
            }
    ...
    function I(G, _) {
        ...
        function E(K, J) {
            ...
            function C() {
                ...
                for (var C = 0; C < D.length; C++) if (D[C].name == J.skin) $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name + "/messagedatepicker.css\" charset=\"" + D[C].charset + "\"/>");
